...
# StringIO is not availlable in python3
# use io instead
...
def captureTestImage(settings, width, height):
    ...
    # replace StringIO and its function to available io and its equivalent function
...
# python3 requires () for print statement, so change all print "" to print("")
...
while (True):
    ...
    # python3 do not have xrange function, use range instead
